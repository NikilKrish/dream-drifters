export type AnalyticsEvent = 'chapter_viewed' | 'service_selected' | 'package_selected' | 'package_stage_changed' | 'itinerary_opened' | 'enquiry_submitted' | 'whatsapp_continued';
